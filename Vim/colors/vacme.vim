...
exe "hi! StatusLine"    ." guifg=".s:W4    ." ctermfg=".s:WC4    ." guibg=".s:C1    ." ctermbg=".s:WC1    ." cterm=underline"    ." gui=underline"
...
exe "hi! Comment"     ." cterm=none ctermfg=".s:GC3
...
exe "hi! String"      ." ctermbg=".s:WC1
exe "hi! todo"        ." cterm=bold"
exe "hi! MatchParen"  ." cterm=bold,underline"
