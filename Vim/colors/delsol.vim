" Vim color file - delsol
" Generated by http://bytefluent.com/vivify 2016-01-31
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Special guifg=#ffec16 guibg=NONE guisp=NONE gui=NONE ctermfg=220 ctermbg=NONE cterm=NONE
...
hi Operator guifg=#ffec16 guibg=NONE guisp=NONE gui=bold ctermfg=220 ctermbg=NONE cterm=bold
...
hi PreProc guifg=#8abade guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
...
hi Type guifg=#8abade guibg=NONE guisp=NONE gui=bold ctermfg=110 ctermbg=NONE cterm=bold
